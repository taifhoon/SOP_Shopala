    ...
    <section class="section" id="app">
      ...
      <div class="box">
        ...
        <div class="columns">
          ...
          <div class="column is-4 is-align-self-center">Standard Delivery - ส่งธรรมดาในประเทศ <br> จะได้รับภายใน 3 - 4
            วัน
          </div>
          ...
          <div class="row">
            <div class="columns my-5 px-3 buttons">
              ...
              <button class="column button is-dark" style="height: 200px;" @click="payment(order.order_id)">
                ...
                <img src="https://d.line-scdn.net/linepay/partner/images/th/logo/linepay_logo_238x54_v5_th.png"
                  alt="Placeholder image" style="
                  height: 100px;
                  margin-left: auto;
                  margin-right: auto;" />
      ...
      <div class="modal" :class="{ 'is-active': checkPayment }">
        ...
        <div class="modal-card">
          <header class="modal-card-head">
            <p class="modal-card-title "><b class="is-size-3">ชำระเงินสำเร็จ</b></p>
          </header>
          <section class="modal-card-body">
            <img class="my-3" src="https://cdn-icons-png.flaticon.com/512/992/992650.png" alt="Placeholder image" style="
                height: 100px;
                margin-left: auto;
                margin-right: auto;" />
          ...
          <footer class="modal-card-foot">
            <router-link to="/customer/myorder/" class="card-footer-item has-text-light">
              <button class="button has-background-black has-text-white">ยืนยัน</button>
            </router-link>
          </footer>
        </div>
      </div>
      ...
      <div class="modal" :class="{ 'is-active': localdata }">
        ...
        <div class="modal-card">
          ...
          <section class="modal-card-body">
            ...
            <div class="box">
              <div class="columns">
                <input type="radio" id="1" name="customRadio" class="custom-control-input" v-model="condition"
                  value="1" />
            ...
            <div class="box">
              <div class="columns">
                <input type="radio" id="2" name="customRadio" class="custom-control-input" v-model="condition"
                  value="2">
                <div class="column is-4 mt-2">
                  <div class="has-text-left ">
                    <p>วรณัน วารีประเสริฐ</p>
